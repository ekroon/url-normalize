...
use url_normalize::{
    normalize_url, EmptyQueryValue, Options, Protocol, QueryFilter, RemoveDirectoryIndex,
...
#[allow(dead_code)]
fn nerr(url: &str) -> bool {
    normalize_url(url, &Options::default()).is_err()
}
        ...
        nopt(
            ...
            Options {
                ...
                remove_query_parameters: RemoveQueryParameters::List(vec![
                    QueryFilter::Predicate(Box::new(|k| k.to_lowercase().starts_with("utm_"))),
        ...
        nopt(
            ...
            Options {
                remove_query_parameters: RemoveQueryParameters::List(vec![
                    ...
                    QueryFilter::Predicate(Box::new(|k| k.starts_with("foo2")))
                ]),
                ..Options::default()
            }
        ),
...
fn test_js_removedirectoryindex_option() {
    ...
    assert_eq!(
        nopt(
            "http://sindresorhus.com/index.php",
            Options {
                remove_directory_index: RemoveDirectoryIndex::List(vec![
                    QueryFilter::Exact("index.html".to_string()),
                    QueryFilter::Exact("index.php".to_string())
    ...
    assert_eq!(
        nopt(
            ...
            Options {
                remove_directory_index: RemoveDirectoryIndex::List(vec![
                    QueryFilter::Predicate(Box::new(|name| {
                        let re_match = name.starts_with("index.")
                            && name.len() > 6
                            && name[6..].bytes().all(|b| b.is_ascii_lowercase());
                        re_match
                    })),
                    QueryFilter::Exact("remove.html".to_string())
                ]),
                ..Options::default()
            }
        ),
    ...
    assert_eq!(
        nopt(
            "http://sindresorhus.com/remove.html",
            Options {
                remove_directory_index: RemoveDirectoryIndex::List(vec![
                    QueryFilter::Predicate(Box::new(|name| {
                        let re_match = name.starts_with("index.")
    ...
    assert_eq!(
        nopt(
            "http://sindresorhus.com/index.html",
            Options {
                remove_directory_index: RemoveDirectoryIndex::List(vec![QueryFilter::Predicate(
                    Box::new(|name| name.starts_with("index."))
                )]),
                ..Options::default()
            }
        ),
...
fn test_js_data_url() {
    ...
    assert_eq!(
        n("data:;base64, Zm9v #foo #bar"),
        "data:;base64,Zm9v#foo #bar",
        "line 428"
    );
    assert_eq!(n("data:, foo #bar"), "data:, foo #bar", "line 431");
    assert_eq!(
        nopt(
            "data:,sindresorhus.com/",
            Options {
                strip_hash: true,
                ..Options::default()
            }
    ...
    assert_eq!(
        nopt(
            "data:,sindresorhus.com/index.html",
            Options {
                strip_hash: true,
                ..Options::default()
            }
    ...
    assert_eq!(
        nopt(
            "data:,sindresorhus.com?foo=bar&a=a&utm_medium=test",
            Options {
                strip_hash: true,
                ..Options::default()
            }
...
fn test_js_ignore_custom_schemes() {
    ...
    assert_eq!(
        n("mailto:office@foo.com"),
        "mailto:office@foo.com",
        "line 474"
    );
    assert_eq!(
...
fn test_js_customprotocols_option() {
    ...
    assert_eq!(
        nopt(
            "sindre://sorhus.com?foo=bar&utm_source=test",
            Options {
                custom_protocols: vec!["sindre".to_string()],
                ..Options::default()
            }
    ...
    assert_eq!(
        nopt(
            "sindre://sorhus.com?foo=bar&baz=qux",
            Options {
                custom_protocols: vec!["sindre".to_string()],
...
fn test_js_encoded_backslashes_do_not_get_decoded() {
    assert_eq!(
        n("https://foo.com/some%5Bthing%5Celse/that-is%40great@coding"),
        "https://foo.com/some[thing%5Celse/that-is%40great@coding",
        "line 578"
    );
    assert_eq!(
...
fn test_js_transformpath_option() {
    assert_eq!(
        nopt(
            ...
            Options {
                transform_path: Some(Box::new(|parts| if parts.is_empty() {
                    vec![]
                } else {
                    vec![parts[0].clone()]
                })),
    ...
    assert_eq!(
        nopt(
            "https://example.com/path/admin/page",
            Options {
                transform_path: Some(Box::new(|parts| parts
                    .into_iter()
                    .filter(|p| p != "admin")
        ...
        nopt(
            ...
            Options {
                transform_path: Some(Box::new(|parts| {
                    if parts.first().map(|s| s.as_str()) == Some("api") {
                        vec![parts[0].clone()]
                    } else {
                        vec![]
                    }
...
fn test_js_path_like_query_strings_without_equals_signs_are_preserved() {
    ...
    assert_eq!(
        n("https://example.com/app.php?/admin/dashboard"),
        "https://example.com/app.php?/admin/dashboard",
        "line 638"
    );
    assert_eq!(
        n("https://example.com/index.php?/path/"),
        "https://example.com/index.php?/path",
        "line 640"
    );
    assert_eq!(
        nopt(
    ...
    assert_eq!(
        n("https://example.com/index.php?b=2&/path/to/resource&a=1"),
        "https://example.com/index.php?/path/to/resource&a=1&b=2",
        "line 645"
    );
    assert_eq!(
        n("https://example.com/index.php?/path&param=value"),
        "https://example.com/index.php?/path&param=value",
        "line 646"
    );
    assert_eq!(
    ...
    assert_eq!(
        n("https://example.com/index.php?/path&/longpath"),
        "https://example.com/index.php?/longpath&/path",
        "line 661"
    );
    assert_eq!(
        n("https://example.com/index.php?key&anotherkey"),
        "https://example.com/index.php?anotherkey&key",
        "line 662"
    );
    assert_eq!(
        n("https://example.com/index.php?/api&/api/v1/users"),
        "https://example.com/index.php?/api&/api/v1/users",
        "line 663"
    );
}
...
fn test_js_sortqueryparameters_should_preserve_encoded_reserved_characters_in_query_values() {
    ...
    assert_eq!(
        n("https://example.com/?A=1&%3A=2"),
        "https://example.com/?%3A=2&A=1",
        "line 686"
    );
    assert_eq!(
    ...
    assert_eq!(
        n("https://example.com/?foo%3Dbar=1&a=2"),
        "https://example.com/?a=2&foo%3Dbar=1",
        "line 688"
    );
    assert_eq!(
    ...
    assert_eq!(
        n("https://example.com/?token=a/b&utm_source=test"),
    ...
    assert_eq!(
        nopt(
            "https://example.com/?token=%3A%2F%3F",
            Options {
                sort_query_parameters: false,
                ..Options::default()
            }
...
fn test_js_emptyqueryvalue_option() {
    ...
    assert_eq!(
        nopt(
            "https://example.com?foo&bar&baz=value",
            Options {
                empty_query_value: EmptyQueryValue::Always,
                ..Options::default()
            }
    ...
    assert_eq!(
        nopt(
            "https://example.com?key&utm_source=test",
            Options {
                sort_query_parameters: false,
                ..Options::default()
            }
    ...
    assert_eq!(
        nopt(
            "https://example.com?foo+bar=value",
            Options {
                sort_query_parameters: false,
                ..Options::default()
            }
